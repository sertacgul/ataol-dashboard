  ...
  return (
    <div className="max-w-xl">
      <div className="flex items-center gap-3 mb-5">
        ...
        <span className="text-sm font-semibold text-[#111827]">Yeni Lead</span>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="bg-white border border-[#E5E7EB] rounded-md p-4 mb-4">
          <h2 className="text-sm font-semibold text-[#111827] mb-4">Firma Bilgileri</h2>
          <div className="space-y-3">
            <div>
              <label className={labelClass}>Firma Adı <span className="text-[#DC2626]">*</span></label>
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-md p-4 mb-5">
          <h2 className="text-sm font-semibold text-[#111827] mb-4">İletişim Kişisi</h2>
          <div className="space-y-3">
            <div>
