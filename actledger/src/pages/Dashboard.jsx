    ...
    <div>
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-md overflow-hidden">
        <div className="px-4 py-3 border-b border-[#E5E7EB] bg-[#F9FAFB] flex items-center justify-between">
          <h2 className="text-xs font-semibold text-[#374151]">Son Outreach</h2>
          <Link to="/app/outreach" className="text-xs text-[#2563EB] hover:underline">Tümünü gör</Link>
        </div>
        {!stats?.recent_emails?.length ? (
          <div className="text-xs text-[#9CA3AF] text-center py-8">Henüz email bulunmuyor.</div>
        ) : (
