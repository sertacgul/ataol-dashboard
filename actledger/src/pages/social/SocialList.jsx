...
function PlatformBadge({ platform }) {
  ...
  return (
    <span
      className="inline-flex text-[10px] font-medium px-2 py-0.5 rounded-full text-white"
    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <h1 className="text-base font-semibold text-[#111827]">Sosyal Medya</h1>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[#E5E7EB] bg-[#F9FAFB]">
              ...
              <th className="text-left text-xs font-medium text-[#6B7280] px-4 py-2">İçerik</th>
