...
export default function LegalShell({ title, updated, children }) {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'linear-gradient(180deg, #eff6ff 0%, #f5f9ff 40%, #F9FAFB 100%)' }}>
      <div style={{ height: '4px', background: 'linear-gradient(90deg, #2563EB 0%, #93C5FD 100%)' }} />
      <header className="bg-white/70 backdrop-blur border-b border-[#DBEAFE]">
      ...
      <main className="flex-1 py-12 px-4">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white border border-[#DBEAFE] rounded-xl shadow-[0_1px_3px_rgba(37,99,235,0.06),0_8px_24px_rgba(37,99,235,0.06)] p-8 sm:p-10">
      ...
      <footer className="border-t border-[#DBEAFE] bg-white/70 backdrop-blur">
